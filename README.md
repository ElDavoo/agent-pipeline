...
request. It is bounded at three restarts per head commit, counted by `<!-- agent-review-queued
sha=… -->` markers, and past that the pull request is labelled `agent:stuck` and drafted. The
